...
from client.stc_classes.measure import Velocity
...
class TestSTCPosition(unittest.TestCase):
    ...
    def test_PKTable(self):      
        ...
        self.assertEqual(velocity.error.__repr__(), 
                         "[Bound3D: [[1.0 1.2]mas/year [2.1 2.3]mas/year [2345 2399]km/sec]")
        ...
        self.assertEqual(velocity.__repr__(), 
                         "ucd: phys.veloc coords: [LonLatPoint: 1.1mas/year 2.2mas/year 2345.98km/sec ICRS] error: [Bound3D: [[1.0 1.2]mas/year [2.1 2.3]mas/year [2345 2399]km/sec]")
